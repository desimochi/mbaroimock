      ...
      <footer className="bg-red-800 text-gray-100 py-8 px-24">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <Link
              href="https://www.facebook.com/MBAROI.IN/"
            ...
            <Link
              href="https://twitter.com/mbaroi_in"
              className="hover:text-gray-300"
              aria-label="Twitter"
            >
              <svg
            ...
            <Link
              href="https://www.instagram.com/mbaroi.in/"
              className="hover:text-gray-300"
        ...
        <div className="mt-6 text-center text-sm text-gray-200">
          &copy; 2025 <Link href="https://mbaroi.in/">MBAROI.in</Link>. All rights reserved.
        </div>
      </footer>
    );
  }
